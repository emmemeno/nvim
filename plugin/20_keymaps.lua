...
vim.api.nvim_create_user_command("W", "w", { nargs = 0, bang = true })
vim.api.nvim_create_user_command("WQ", "wq", { nargs = 0, bang = true })
vim.api.nvim_create_user_command("Wq", "wq", { nargs = 0, bang = true })
vim.api.nvim_create_user_command("Wa", "wa", { nargs = 0, bang = true })
vim.api.nvim_create_user_command("Q", "q", { nargs = 0, bang = true })
vim.api.nvim_create_user_command("Qa", "qa", { nargs = 0, bang = true })
...
nmap_leader('fm', '<Cmd>Pick marks scope=globe<CR>',            'Modified hunks (all)')
nmap_leader('fM', '<Cmd>Pick marks scope=buf<CR>',              'Modified hunks (all)')
